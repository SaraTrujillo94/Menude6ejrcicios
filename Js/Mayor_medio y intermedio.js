...
else if (numero1<numero3 & numero3<numero2){ /* 2 if para una probabilidad de cual sera el menor mayor y intermedio*/document.resultados1.resulmayor.value= numero2;  
document.resultados1.resulmenor.value= numero1;
